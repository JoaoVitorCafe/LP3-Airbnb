...
class ControllerNovoImovel{
   ...
   public function processaRequisicao(){ 
    ...
    $this->imovel = new Imovel($_SESSION["id"] , $idCartao , $idEndereco , $_POST['capacidade_pessoas'] , $_POST['descricao'] , intval($_POST['tipo_imovel']) , $_POST['preco_locacao'] , $_FILES['imagem']);
