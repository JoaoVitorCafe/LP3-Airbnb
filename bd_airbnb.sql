...
CREATE TABLE IF NOT EXISTS `bd_airbnb`.`comentarios` (
  ...
  `data_postagem` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bd_airbnb`.`alugueis` (
  ...
  INDEX `fk_alugueis_usuarios1_idx` (`usuarios_idusuarios` ASC),
  INDEX `fk_alugueis_cartoes1_idx` (`cartoes_idcartao` ASC),
